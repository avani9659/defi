...
contract DeFiPlatform is RequestFactory {
    ...
    event LoanGiven();
    event LoanReturned();
    event LoanDefaulted(); //certain amount was collected as part of collateral
    ...
    //This will be a payable function, as we will be sending in some ethers as part of collateral.
    function ask(
        uint256 _amount,
        ...
        // add created lendingRequest to management structures, this will be used for mapping iterators
    ...
    function lend(
        ...
        require(
            validRequests[_requestContractAddress],
